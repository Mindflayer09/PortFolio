...
const Hero = () => {
  return (
    <header className="relative min-h-screen flex items-center justify-center pt-24 pb-16 px-5 md:px-8 overflow-hidden">
      ...
      {/* THE FIX: Using pure CSS radial gradients instead of blurred divs to ensure vibrant colors on mobile */}
      <div 
        className="absolute inset-0 z-0 pointer-events-none" 
        style={{ 
          background: `
            radial-gradient(circle at 20% 35%, rgba(209, 188, 255, 0.15) 0%, transparent 50%),
            radial-gradient(circle at 80% 65%, rgba(93, 230, 255, 0.12) 0%, transparent 50%)
          `
        }}
      ></div>
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 w-full sm:w-auto px-4 sm:px-0">
          <motion.a 
            ...
            href="mailto:singhsourav090305@gmail.com?subject=Opportunity"
          >
            Contact Me
          </motion.a>
          <motion.a 
          ...
          <div className="bg-black/40 p-6 md:p-10 rounded-[2rem] border border-white/5 shadow-2xl">
            <form onSubmit={handleSubmit} className="flex flex-col gap-5 md:gap-6">
              ...
              {submitStatus === 'success' && (
                <p className="text-green-400 text-xs md:text-sm font-medium text-center mt-2">Message sent successfully!</p>
              )}
            </form>
          </div>
        </motion.div>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4 relative z-10">
          <a 
            ...
            target="_blank"
            rel="noreferrer"
            className="md:hidden flex items-center justify-center gap-2 px-8 py-4 bg-[#c4a5ff] text-[#0a081a] font-black text-sm tracking-widest uppercase rounded-full shadow-[0_0_15px_rgba(196,165,255,0.3)]"
          >
            Open Resume
          </a>
          <a 
    ...
    <footer className="bg-surface-container-lowest w-full py-8 md:py-12 px-6 md:px-12 border-t border-outline-variant/15">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-5 md:gap-6">
        ...
        <div className="flex gap-6 items-center text-slate-500">
          <a className="hover:text-[#c4a5ff] hover:-translate-y-1 transition-all duration-300 p-2 md:p-0" href="https://github.com/Mindflayer09" target="_blank" rel="noreferrer" aria-label="GitHub">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.02c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A4.8 4.8 0 0 0 8 18v4"/><path d="M 9 18c-4.51 2-5-2-7-2"/></svg>
          </a>
          <a className="hover:text-[#c4a5ff] hover:-translate-y-1 transition-all duration-300 p-2 md:p-0" href="https://www.linkedin.com/in/sourabh-singh09" target="_blank" rel="noreferrer" aria-label="LinkedIn">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
          </a>
        </div>
      </div>
...
export default function App() {
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden">
      <motion.div className="fixed top-0 left-0 right-0 h-0.5 bg-linear-to-r from-secondary to-tertiary z-60 origin-left" style={{ scaleX }} />
      <Navbar />
      <main>
        <Hero />
        <About />
      ...
      <Footer />
      {/* THE FIX: Pure CSS radial gradients to prevent "washed out" look on mobile browsers */}
      <div 
        className="fixed inset-0 -z-10 pointer-events-none"
        style={{
          background: `
            radial-gradient(circle at 90% 10%, rgba(196, 165, 255, 0.07) 0%, transparent 50%),
            radial-gradient(circle at 10% 90%, rgba(93, 230, 255, 0.07) 0%, transparent 50%)
          `
        }}
      ></div>
    </div>
